...
// 			                                        
		...
		// else if($order_status!="Canceled") {
			...
			//$orderinfo = $this->getOrederDetails($order_id);	
	...
	{
		$query = $this->db->select('order_detail.*,store.product_slug as product_slug,order_detail.color_id as colname,order_detail.size_id as sizename,store.*,bars.bar_title as barname,order_detail.quantity as quantity')
		                  ->from('order_detail')
	...
	function get_one_order_info($id)
	{
		$query = $this->db->select('*,order_master.status as status')
		                  ->from('order_master')
						  ->join('user_master','user_master.user_id=order_master.user_id')
