...
$(document).ready(function(){
	...
	function delete_rec(id,redirectpage,option,keyword,$gallery_id,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>bar_gallery/delete_gallery/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+$gallery_id+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getlimit(limit)
	{
		...
		{
		 window.location.href= '<?php echo base_url();?>bar_gallery/list_gallery/'+limit+'/<?php echo $bar_id ?>';
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>bar_gallery/search_list_gallery/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
...
<div class="page_content">
    ...
    <?php } ?>
				<div class="row_fluid"> 
					...
					echo form_open('bar_gallery/search_list_gallery/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<span class="sspan fl_left ">&nbsp;&nbsp;&nbsp;Search By</span>&nbsp;
                            ...
                            <input type="submit" name="submit" id="submit" value="Search" class="btn blue  fl_left mar10" /> 
                             ...
                             <input type="button" name="refresh" id="refresh" value="Refresh" class="btn blue  fl_left mar10" onclick="document.location.href = '<?php echo site_url("bar_gallery/list_gallery/".$limit.'/'.$bar_id); ?>'" /> 
								</form>
								</div>
									<div class="fl_right">
					...
					<?php echo anchor('bar_gallery/add_gallery/'.$bar_id,'Add New', 'class="btn blue  fl_left mar_r_5" id="addgallery"'); ?>
					...
					<div class="clear"></div>		
									...
									<div class="clear"></div>
			<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>bar_gallery/action_gallery" method="post">
	<input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
				   ...
				   <input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo $redirect_page;?>"/>
									...
									<table class="table table-striped table-bordered sorted_table table border" >
												...
												<th class="sorting_disabled" style="width: 6%;">Bar Title</th>
								...
								if($result)
								{
									...
									<td style="text-align: center;">	
										...
										<?php echo  anchor('bar_gallery/edit_gallery/'.$row->bar_gallery_id.'/'.$redirect_page.'/'.$option.'/'.$keyword.'/'.$limit.'/'.$offset."/".$bar_id,'<i class="comon_icon edit_icon"></i>','class="table_icon btn blue" id="gallery_'.$row->bar_gallery_id.'" title="Edit gallery"');  ?>
