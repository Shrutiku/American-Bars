...
$(document).ready(function() {
   ...
   function back_invoice()
    {	
	   	...
	   	window.location.href="<?php echo base_url().'order/orderlist';?>";   
  ...
  <tr>
  	<td colspan="2">
  		...
  		<table  cellpadding="4" cellspacing="4" width="100%" style="border-collapse: collapse; border: 1px solid #000; text-align: left;margin-top: 20px;" >
  			<thead>
  				<th class="fnt-siz" style="background-color: #4c4129;  border-bottom: solid 1px #816f46;   font-weight: bold;  padding: 5px 10px; color: #fff;">Barname</th>
  			...
  			<tbody>
  				...
  				<tr style="border-bottom: double 4px #816f46;">
  					<td class="fnt-siz"  style="padding: 10px 5px;"><?php echo $row->barname?></td>
  					<td class="fnt-siz" >
