...
$(document).ready(function(){
	...
	{
		var ans = confirm("Are you sure, you want to delete liquor_suggestion?");
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>liquor_suggestion/delete_liquor_suggestion/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>liquor_suggestion/list_liquor_suggestion/'+limit+'/<?php echo $bars_id ?>';
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>liquor_suggestion/search_list_liquor_suggestion/'+limit+'/<?php echo $bars_id.'/'.$option.'/'.$keyword; ?>';
		}
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>liquor_suggestion/list_liquor_suggestion/<?php echo $bars_id ?>';
		}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">Liquor Suggestion Directory</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">Liquor Suggestion  Directory</div>
							<div class="fl_right">
					...
					echo form_open('liquor_suggestion/search_list_liquor_suggestion/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<span class="sspan fl_left ">&nbsp;&nbsp;&nbsp;Search By</span>&nbsp;
                            <select name="option" id="option" onchange="gomain(this.value)"  class="m_wrap fl_left mar0" style="padding:6px;">
                                ...
                                <option value="liquor_title" <?php if($option=='liquor_title'){?> selected="selected"<?php }?>>Liquor Name</option>  
					...
					<input type="hidden" name="bars_id" id="bars_id" value="<?php echo $bars_id; ?>" />
                            ...
                            <input type="button" name="refresh" id="refresh" value="Refresh" class="btn blue  fl_left mar10" onclick="document.location.href = '<?php echo site_url("liquor_suggestion/list_liquor_suggestion/20/".$bars_id); ?>'" /> 
								</form>
								</div>
					<div class="fl_right">	
					...
					<div class="clear"></div>
									...
									<div class="clear"></div>
								<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>liquor_suggestion/action_liquor_suggestion" method="post">
								...
								<div class="scroll-pane horizontal-only" >		<table class="table border" >
												...
												<th class="sorting" align="center" style="width: 5%;">View</th>
								...
								if($result)
								{
									...
									<td  style="width: 30px;"><input type="checkbox" name="chk[]" value="<?php echo $row->liquor_id ?>" class="chk"  /></td>
														...
														<td><?php echo $row->liquor_title; if($row->states == 'unread')
														{?>
														...
														<td class="center">
															<a class="btn blue mini" href="<?php echo site_url("liquor_suggestion/viewliquor/".$row->liquor_id); ?>" title="View">View</a>
														</td>
