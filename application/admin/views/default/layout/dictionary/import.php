...
jQuery(document).ready(function(){
    ...
    form1.validate({
        ...
        ignore: "",
        rules:{
            csv: {required: true,  extension: "csv"}
...
<div class="page_content">
			<div class="container_fluid">
				<div class="row_fluid"> 
					<h3 class="page_title">Import CSV</h3>					
				</div>
				<div class="row_fluid"> 
				<?php  
				if($msg != "") {
						
						if($msg == 'csv_not_valid') {
							echo '<div class="error_red"><p>Csv File Not Valid.</p></div>';
		}
		}	
					if($error != "") {
				...
				echo form_open_multipart('dictionary/import_csv',$attributes);
			  ?>
