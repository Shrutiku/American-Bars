...
$(document).ready(function(){
	...
	function delete_rec(id,redirectpage,option,keyword,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>user/delete_user/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>user/search_list_poker/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">List User</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">User listing</div>
							<div class="fl_right">
					...
					echo form_open('user/search_list_poker/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<?php echo anchor('user/add_user','Add New', 'class="btn blue  fl_left mar_r_5" id="adduser"'); ?>
	...
	<input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
				   ...
				   <input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo $redirect_page;?>"/>
									<table class="table border" >
												...
												<th class="sorting" style="width: 5%;">User Type</th>
												<th class="sorting" style="width: 5%;">Expired day</th>
								...
								if($result)
								{
									...
									<td  style="width: 30px;"><input type="checkbox" name="chk[]" value="<?php echo $row->user_id ?>" class="chk"  /></td>
														...
														<td><?php if($row->user_type='poker_coach'){ echo "Poker Coach" ; }  ?></td>
														<td> <?php
																 //echo $d= $row->coach_date;
																if($row->coach_date !='0000-00-00' && $row->coach_date !=''){
																		
																	echo get_date($row->coach_date)." Day(s)";		
															 ...
															 ?> </td>
														<td class="center">
															<?php $cls = ($row->right_upload=='yes')?'purple':'yellow';?>
															<span class="<?php echo $cls;?>"><?php echo $row->right_upload; ?></span>
														</td>
						...
						?>
														...
														<?php echo  anchor('user/edit_user/'.$row->user_id.'/'.$redirect_page.'/'.$option.'/'.$keyword.'/'.$limit.'/'.$offset,'<i class="comon_icon edit_icon"></i>','class="table_icon btn blue" id="user_'.$row->user_id.'" title="Edit user"');  ?>
														<a class="table_icon btn red" href="javascript://" onClick="delete_rec('<?php echo $row->user_id; ?>','<?php echo $redirect_page;?>','<?php echo $option?>','<?php echo $keyword?>','<?php echo $limit?>','<?php echo $offset; ?>')" title="Delete"><i class="comon_icon delete_icon"></i></a>
														</td>
													</tr>
								<?php $i++;} }else{ ?>
