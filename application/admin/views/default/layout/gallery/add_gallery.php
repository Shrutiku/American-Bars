...
<div class="page_content">
			<div class="container_fluid">
				...
				echo form_open_multipart('gallery/add_gallery/'.$bar_gallery_id,$attributes);
			  ?>
									...
									<div class="control-group">
											...
											<div class="clear"></div>
											<div class="control_group">
										<label class="control_label">Image Description:</label>
										<div class="controls">
											<textarea class="wid360 m_wrap"  name="image_title[]" id="image_title[]"><?php echo @$im->image_title; ?></textarea>
										</div>										
										<div class="clear"></div>
									</div>
									...
									<div class="control_group">
										...
										<div class="controls">
											<input type="text" placeholder="Link...." class="m_wrap wid360" name="image_link[]" id="image_link[]" value="<?php echo @$im->image_link; ?>"  />
										</div>										
										<div class="clear"></div>
									</div>
										...
										<label class="control_label">Image Description:</label>
										<div class="controls">
											<textarea placeholder="Image Description...." class="m_wrap wid360" name="image_title[]" id="image_title[]" ><?php echo @$im->image_title; ?></textarea>
										</div>										
										<div class="clear"></div>
									</div>
									<div class="clear"></div>
						...
						{?>
						<input type="button" name="Cancel" value="Cancel" class="btn red  fl_left" onClick="location.href='<?php echo base_url(); ?>gallery/<?php echo $redirect_page.'/'.$limit.'/'.$bar_id.'/'.$offset?>'" />
						<?php }else
						{?>
						<input type="button" name="Cancel" value="Cancel" class="btn red  fl_left" onClick="location.href='<?php echo base_url(); ?>gallery/<?php echo $redirect_page.'/'.$limit.'/'.$bar_id.'/'.$option.'/'.$keyword.'/'.$offset?>'" />
					...
					<?php }else { ?>
						...
						<input type="submit" id="submit" name="submit" value="Update" class="btn green fl_left mar_r_5" />
...
<script>
	$('#add_row').click(function(){
	  //if(parseInt($('#cntpro').val())<7){
		...
		$('#inner').append('<div id="img_'+cnt+'" style="display:none;"><div class="controls"><div class="fileupload fileupload-new" data-provides="fileupload"><div class="uneditable-input"><i class="icon-file fileupload-exists"></i><span class="fileupload-preview"></span></div><span class="btn btn-file"><span class="fileupload-new">Select file</span><span class="fileupload-exists">Change</span><input type="file" class="default"  accept="image/*" name="photo_image[]" id="photo_image_'+cnt+'" /></span></div></div><div class="controls"><div class="span3"><a href="javascript://" class="table_icon btn red" onclick="removeImageDive(\''+cnt+'\')"><i class="comon_icon delete_icon"></i></a></div></div><div class="clear"></div><div class="control_group"><label class="control_label">Image Description:</label><div class="controls"><textarea placeholder="Image Description...." class="m_wrap wid360" name="image_title[]" id="image_title[]" ></textarea></div><div class="clear"></div><div class="control_group"><label class="control_label">Link:</label><div class="controls"><input type="text" placeholder="Link...." class="m_wrap wid360" name="image_link[]" id="image_link[]" value=""  /></div><div class="clear"></div></div></div><div class="clear"></div></div>');
		$('#img_'+cnt).slideDown();
...
function removeImageDiveAjax(id)
{
	...
	{
		$.ajax({
			url:'<?php echo site_url('gallery/removeImageAjax') ?>/'+id,
