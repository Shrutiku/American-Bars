<script type="text/javascript" language="javascript">
	...
	function delete_rec(id,redirectpage,option,keyword,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>state/delete_state/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">List State</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">State listing</div>
							<div class="fl_right">
					...
					echo form_open('state/search_list_state/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<?php echo anchor('state/add_state','Add New', 'class="btn blue  fl_left mar_r_5" id="addstate"'); ?>
					...
					<div class="clear"></div>		
									...
									<div class="clear"></div>
			<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>state/action_state" method="post">
	<input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
				   ...
				   <input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo $redirect_page;?>"/>
								...
								if($result)
								{
									...
									<td  style="width: 30px;"><input type="checkbox" name="chk[]" value="<?php echo $row->state_id ?>" class="chk"  /></td>
														<td class=" sorting_1"><?php echo $row->state_name; ?></td>
								...
								echo anchor('state/edit_state/'.$row->state_id.'/'.$redirect_page.'/'.$option.'/'.$keyword.'/'.$limit.'/'.$offset,'<i class="comon_icon edit_icon"></i>','class="table_icon btn blue" id="state_'.$row->state_id.'" title="Edit state"'); 
						?>
														<!-- future enhancement
														...
														<a class="table_icon btn red" href="javascript://" onClick="delete_rec('<?php echo $row->state_id; ?>','<?php echo $redirect_page;?>','<?php echo $option?>','<?php echo $keyword?>','<?php echo $limit?>','<?php echo $offset; ?>')" title="Delete"><i class="comon_icon delete_icon"></i></a>
														</td>
													</tr>
								<?php $i++;} }else{ ?>
													...
													<tr class="odd">
														<td class=" sorting_1" colspan="5" style="text-align:center!important;">No Records Found</td>
