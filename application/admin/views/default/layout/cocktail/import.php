...
<div class="page_content">
			<div class="container_fluid">
				<div class="row_fluid"> 
					<h3 class="page_title">Import xls</h3>					
				</div>
				<div class="row_fluid"> 
				<?php  
				if($msg != "") {
				...
				?>		
					<div class="portlet blue">
						...
						<div class="portlet-body form">
							<div class="content">
								<?php
				$attributes = array('id'=>'import','name'=>'import','class'=>'main');
				echo form_open_multipart('cocktail/import_csv',$attributes);
			  ?>
												...
												<div class="fileupload fileupload-new" data-provides="fileupload">
													<div class="input-append">
														<div class="uneditable-input"><i class="icon-file fileupload-exists"></i><span class="fileupload-preview"></span></div>
															...
															<span class="fileupload-exists">Change</span><input type="file" class="default" name="csv" id="csv" /></span>
															<a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
															<div class="clearfix"></div>
															<span for="csv" style="display: none;" generated="true" class="help-inline">Please select file with xls extension.</span>
														</div>														
													</div>
												</div>
