...
<div class="page_content">
			...
			<input type="hidden" name="cocktail_slug" id="cocktail_slug" value="<?php echo @$cocktail_slug; ?>" />
									...
									<div class="control_group">
										<label class="control_label">Glassware: </label>
										<div class="controls">
											<input maxlength="100" type="text" placeholder="Glassware...." class="m_wrap wid360" name="glassware" id="glassware" value="<?php echo $glassware; ?>">
										</div>										
										<div class="clear"></div>
									</div>									
									<!-- <div class="control_group">
