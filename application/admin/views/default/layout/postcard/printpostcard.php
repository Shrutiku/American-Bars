...
$html .= '<div style="width:6in; height:4in; font-family: Calibri; color: #000; overflow: hidden; font-size: 11px; letter-spacing: .8px; margin-left: 3in; <!--transform: rotate(90deg) scale(1.03);-->">';
