...
$html .= '<div style="width:.25in; height:100%;rotate:90; border: solid 1px #996E13"></div>
        <div style="width:2.3125in;rotate:90; height:100%;">
            <div style="text-align: left; border: solid 1px #996E13; width: 1.5in; height: 100%; font-size: 12px; rotate:90;"></div>
              <div style="font-family: courier; text-align: left; font-size: 11px; width:100%; border: solid 1px #996E13; ">
