...
<script type="text/javascript" language="javascript">
	function delete_rec(id,redirectpage,option,keyword,limit,offset) {
		var ans = confirm("Are you sure, you want to delete this push notification message?");
		if(ans) {
			location.href = "<?php echo base_url(); ?>message/delete_push_notification/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getlimit(limit) {
		...
		if(limit=='0'){
			...
			window.location.href='<?php echo base_url();?>message/list_push_notification/'+limit+'/';
		}
	}	
	...
	function getsearchlimit(limit) {
		if(limit=='0') {
			...
			window.location.href='<?php echo base_url();?>message/search_list_push_message/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
	...
	function gomain(x) {
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>message/list_push_notification';
		}
	}
...
<div class="page_content">
			<div class="container_fluid">
				<div class="row_fluid"> 
					<h3 class="page_title">Push Notification</h3>
				</div>
					<?php 
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">Push Notification</div>
							<div class="fl_right">
					...
					<div class="clear"></div>
						...
						<div class="portlet-body form">
							...
							<div class="fl_right">
									...
									<?php echo anchor('message/send_push_notification','Send Push Notification', 'class="btn blue  fl_left mar_r_5" id="addmessage"'); ?>
									...
									<div class="clear"></div>
								<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>message/action_push_notification" method="post">
