...
<script type="text/javascript" language="javascript">
	function delete_rec(id,redirectpage,option,keyword,limit,offset) {
		...
		if(ans) {
			location.href = "<?php echo base_url(); ?>message/delete_message/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getlimit(limit) {
		...
		if(limit=='0'){
			...
			window.location.href='<?php echo base_url();?>message/list_message/'+limit+'/';
		}
	}	
	...
	function getsearchlimit(limit) {
		if(limit=='0') {
			...
			window.location.href='<?php echo base_url();?>message/search_list_message/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
	...
	function gomain(x) {
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>message/list_message';
		}
	}
...
$(document).ready(function(){
	$('.view_message').click(function(){
		...
		$(this).colorbox({href:"<?php echo base_url();?>message/get_message_view?message_id="+msg_id+"&msg_type=inbox", title:'View Message Detail'});
								...
								<div class="scroll-pane horizontal-only" >	
									<table class="table border" >
										<thead>
											...
											<th class="sorting" style="width: 10%;">To</th>
											<th class="sorting" style="width: 15%;">Message</th>
											<th class="sorting" style="width: 5%;">Reply</th>
										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">	
											...
											if($result)
											{
												...
												<tr class="<?php echo $cls ?>">
													...
													<td class=" sorting_1"><?php echo get_user_detail($row->from_user_id, $row->from_user_type )." (".ucfirst($row->from_user_type)." )";?></td>
													...
													<td align="center" style="text-align:center;">
														<a class="table_icon btn blue" href="javascript://" onclick="reply_message('<?php echo $row->message_id; ?>','<?php echo $redirect_page;?>','<?php echo $option?>','<?php echo $keyword?>','<?php echo $limit?>','<?php echo $offset; ?>');" title="Reply"><i class="comon_icon reply_icon"></i></a>
													</td>
													<td>
