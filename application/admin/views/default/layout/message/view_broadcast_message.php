...
<div id="pop_up_box" style="color:#000; width:450px; min-height:300px; padding:0px 10px;" >
	...
	<div class="row_flue">	
		...
		<div class="mesg_right"> ADMIN</div>
	</div>
	...
	<div class="row_flue">	
		...
		<div class="mesg_right" style="width: 100%; text-align: justify; "><?php echo html_entity_decode($message_detail['description']); ?></div>
	</div>
	<div class="row_flue">	
		<div class="mesg_left">Send Date: </div>
