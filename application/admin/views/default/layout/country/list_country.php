<script type="text/javascript" language="javascript">
	...
	function delete_rec(id,redirectpage,option,keyword,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>country/delete_country/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">List country</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">Country list</div>
							<div class="fl_right">
					...
					echo form_open('country/search_list_country/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<?php echo anchor('country/add_country','Add New', 'class="btn blue  fl_left mar_r_5" id="addcountry"'); ?>
					...
					<div class="clear"></div>		
									...
									<div class="clear"></div>
			<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>country/action_country" method="post">
	<input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
				   ...
				   <input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo $redirect_page;?>"/>
								<div class="scroll-pane horizontal-only" >	<table class="table border" >
												...
												<th class="sorting" style="width: 12%;">Name</th>
												<th class="sorting" style="width: 18%;">ISO Code</th>
								...
								if($result)
								{
									...
									<td  style="width: 30px;"><input type="checkbox" name="chk[]" value="<?php echo $row->Country_ID ?>" class="chk"  /></td>
														<td class=" sorting_1"><?php echo $row->Country_Name; ?></td>
														<td><?php echo $row->Countries_ISO_Code; ?></td>
								...
								echo anchor('country/edit_country/'.$row->Country_ID.'/'.$redirect_page.'/'.$option.'/'.$keyword.'/'.$limit.'/'.$offset,'<i class="comon_icon edit_icon"></i>','class="table_icon btn blue" id="country_'.$row->Country_ID.'" title="Edit country"'); 
						?>
														<a class="table_icon btn red" href="javascript://" onClick="delete_rec('<?php echo $row->Country_ID; ?>','<?php echo $redirect_page;?>','<?php echo $option?>','<?php echo $keyword?>','<?php echo $limit?>','<?php echo $offset; ?>')" title="Delete"><i class="comon_icon delete_icon"></i></a>
														</td>
													</tr>
								<?php $i++;} }else{ ?>
