...
<script type="text/javascript">
   ...
   { 
	...
	function Editbeer(id,beer_id)
{
	
		var $modal = $('#ajax-modal');
		 $('body').modalmanager('loading');
		 //alert(this.href);
		 var url='<?php echo base_url(); ?>beer/Editbeercomment/'+id+'/'+beer_id+'/';
		// return false;
		  setTimeout(function(){
								  ...
								  <?php }?>
									...
									<div class="media-body">
										<h4 class="media-heading"><?php echo $re->comment_title; ?> <span><?php echo getDuration($re->date_added); ?> / 
											<a onclick="Editbeer('<?php echo $re->beer_comment_id;?>','<?php echo $one_beer_detail["beer_id"]?>')" href="javascript://">Edit   </a> /
								  ...
								  <?php }?>
											...
											<div class="media-body">
												<h4 class="media-heading"><?php echo $sb->comment_title; ?>  <span><?php echo getDuration($re->date_added); ?> / 
													<a onclick="Editbeer('<?php echo $sb->beer_comment_id;?>','<?php echo $one_beer_detail["beer_id"]?>')" href="javascript://">Edit   </a> /
													<a href="javascript:void(0);" onclick="return conform_delete('<?php echo $one_beer_detail["beer_id"] ?>','<?php echo $sb->beer_comment_id ?>')">Delete  </a></span></h4>
												<p>
											<?php echo $sb->comment; ?>
										 </p>
											</div>
