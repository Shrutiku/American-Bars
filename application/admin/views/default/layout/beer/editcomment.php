...
var url='<?php echo base_url(); ?>beer/Editbeercomment/<?php echo $beer_comment_id;?>/';
var url1='<?php echo base_url(); ?>beer/view_beer_comment/<?php echo $beer_id;?>';
...
<script>
 ...
 $('form#setPstat').click(function(){
 	
        var file= document.getElementById("comment_image");
...
alert(file);
	...
	$('form#setPstatdsadasdasd').click(function()
              		{
              			
              			///var formData = new FormData();
              			//var formData = new FormData($('form')[0]);
              			var formData = new FormData($('#setPstat').find('form')[0]);
