...
$(document).ready(function(){
	...
	function delete_rec(id,redirectpage,option,keyword,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>taxi/delete_taxi/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
	...
	function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>taxi/list_taxi/'+limit+'/';
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>taxi/search_list_taxi/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>taxi/list_taxi/';
		}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">Taxi Directory</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">Taxi Directory</div>
							<div class="fl_right">
					...
					echo form_open('taxi/search_list_taxi/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<span class="sspan fl_left ">&nbsp;&nbsp;&nbsp;Search By</span>&nbsp;
                            ...
                            <input type="submit" name="submit" id="submit" value="Search" class="btn blue  fl_left mar10" /> 
                             ...
                             <input type="button" name="refresh" id="refresh" value="Refresh" class="btn blue  fl_left mar10" onclick="document.location.href = '<?php echo site_url("taxi"); ?>'" /> 
								</form>
								</div>
									<div class="fl_right">
										
										<a href="<?php echo front_base_url().'/upload/taxi.xls';?>" class='btn purple fl_left mar_r_5'>Demo xls</a>
										<?php echo anchor('taxi/import_taxi','Import xls', 'class="btn blue  fl_left mar_r_5" id="addbeer"'); ?>
					<?php echo anchor('taxi/add_taxi','Add New', 'class="btn blue  fl_left mar_r_5" id="addtaxi"'); ?>
					...
					<div class="clear"></div>		
									...
									<div class="clear"></div>
			<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>taxi/action_taxi" method="post">
	<input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
				   ...
				   <input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo $redirect_page;?>"/>
								...
								if($result)
								{
									...
									<td  style="width: 30px;"><input type="checkbox" name="chk[]" value="<?php echo $row->taxi_id ?>" class="chk"  /></td>
														...
														<td class="center">
															...
															$cls = ($row->status=='active')?'purple':'yellow';?>
						...
						?>
														...
														<?php echo  anchor('taxi/edit_taxi/'.$row->taxi_id.'/'.$redirect_page.'/'.$option.'/'.$keyword.'/'.$limit.'/'.$offset,'<i class="comon_icon edit_icon"></i>','class="table_icon btn blue" id="taxi_'.$row->taxi_id.'" title="Edit taxi"');  ?>
