...
$(document).ready(function(){
	...
	function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>archived_beer/list_archived_beer/'+limit+'/<?php echo $bars_id ?>';
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>archived_beer/search_list_archived_beer/'+limit+'/<?php echo $bars_id.'/'.$option.'/'.$keyword; ?>';
		}
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>archived_beer/list_archived_beer/<?php echo $bars_id ?>';
		}
...
<div class="page_content">
			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					<h3 class="page_title">Archived Beer Directory</h3>
				...
				<div class="row_fluid"> 
					<div class="portlet blue">
						<div class="portlet-title">
							<div class="caption fl_left">Archived Beer  Directory</div>
							<div class="fl_right">
					...
					echo form_open('archived_beer/search_list_archived_beer/'.$limit,$attributes);?>
					<div class="fl_left">
					...
					<input type="hidden" name="bars_id" id="bars_id" value="<?php echo $bars_id; ?>" />
                            ...
                            <input type="submit" name="submit" id="submit" value="Search" class="btn blue  fl_left mar10" /> 
                             ...
                             <input type="button" name="refresh" id="refresh" value="Refresh" class="btn blue  fl_left mar10" onclick="document.location.href = '<?php echo site_url("archived_beer/list_archived_beer/20/".$bars_id); ?>'" /> 
								</form>
								</div>
									<div class="fl_right">
					...
					<div class="clear"></div>		
									...
									<div class="clear"></div>
			<form name="frm_listlogin" id="frm_listlogin" action="<?php echo base_url();?>archived_beer/action_archived_beer" method="post">
...
<script>
	function delete_rec(id,redirectpage,option,keyword,bar_id,limit,offset)
	{
		...
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>archived_beer/delete_archived_beer/"+id+"/"+redirectpage+"/"+option+"/"+keyword+"/"+bar_id+"/"+limit+"/"+offset;
		}else{
			return false;
		}
	}
