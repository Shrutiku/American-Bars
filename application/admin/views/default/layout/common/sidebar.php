		...
		<div class="page-sidebar nav-collapse collapse">
			<ul class="sidebar_menu" id="drop_nav">
				...
				<li class="menu_tag <?php echo ($uri[1]=='list_suggest_bar' || $uri[1]=='edit_suggest_bar' ||  $uri[1]=='search_list_suggest_bar' || $uri[1]=='view_suggest_bar')?'active':''; ?>">
					...
					<a href="<?php echo site_url('ambassador/list_ambassador') ?>" <?php echo '';// echo (isset($uri[1]) && ($uri[1]=='list_suggest_bar' || $uri[1]=='view_suggest_bar' || $uri[1]=='search_list_suggest_bar'))?'class="active"':''; ?>><!--<span class="badge badge-info"><?php // echo get_unread_sugbar();?></span>-->
						<i class="sidebar_icon suggest_icon"></i>
