	...
	$("#usualValidate").validate({
		...
		rules: {
			...
			news_desc:{
                       required: function() 
                       {
                          tinyMCE.get('news_desc').getContent(); 
						  tinyMCE.triggerSave();
                       },
                       minlength:3
            }
...
<div class="page_content">
			<div class="container_fluid">
				<div class="row_fluid"> 
					<h3 class="page_title"><?php if($news_id==""){ echo 'Add News'; } else { echo 'Edit News'; }?></h3>
			  ...
			  ?>
			  						...
			  						<div class="control_group">
										<label class="control_label">News Title:<i style="color: #7D2A1C;">*</i></label>
										<div class="controls">
											<input type="text" placeholder="News Title...." class="m_wrap wid360" name="news_title" id="news_title" value="<?php echo $news_title; ?>">
										</div>										
										<div class="clear"></div>
									</div>
									...
									<div class="control_group">
										...
										<div class="controls">
											<textarea name="news_desc" id="news_desc" placeholder="Description..." class="m_wrap span9 wid360" rows="20" cols="100" data-error-container="#editor1_error">
												<?php  echo $news_desc ;?>
											</textarea>
											<label for="news_desc" generated="true" class="error" style="display: none;">This field is required.</label>
										</div>										
										<div class="clear"></div>
							  </div>
									
									<div class="control_group">
										<label class="control_label">News Category:<i style="color: #7D2A1C;">*</i></label>
										<div class="controls">
											<select id="news_category" class="m_wrap wid360" name="news_category">
												<option value="">-Select-</option>
												<option value="latest_news_and_event" <?php if($news_category =='latest_news_and_event'){?> selected="selected" <?php } ?>> Latest News & Events </option>
											</select>
										</div>										
										<div class="clear"></div>
									</div>									
