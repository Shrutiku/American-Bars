			...
			<div class="container_fluid">
				...
				<div class="row_fluid"> 
					...
					<a href="javascript:void(0)" onclick="setaction('chk[]','inactive', 'Are you sure, you want to inactivate selected record(s)?', 'frm_listlogin');" class="btn yellow  fl_left mar_r_5" >Inactive</a>
					 ...
					 <a class="btn yellow  fl_left" href="<?php echo site_url('report/list_taxi_company_report')?>">Back</a>
					...
					<div class="clear"></div>		
							...
							<div class="content ">
									...
									<div class="control_group">
										<label class="control_label">  <h3> Taxi Company Name : </h3>  </label>
										<div class="controls">
											<?php echo $taxi_company; ?>
										</div>										
										<div class="clear"></div>
									</div>
