...
//                       
 ...
 CKEDITOR.replace("bar_desc", 
  {width: "500", height: "300", language: "en", stylesCombo_stylesSet: "my_styles", startupOutlineBlocks: true, entities: false, entities_latin: false, entities_greek: false, 		forcePasteAsPlainText: true, 
		                	...
		                	<div class="control_group">
										...
										<div class="controls" >
											<select class="m_wrap wid360" name="bar_type" id="bar_type"> 
												...
												<option value="full_mug" <?php echo ($bar_type=='full_mug' && $is_managed=='no')?'selected="selected"':''; ?> >Full Mug</option>
												<option value="managed_bar" <?php echo ($bar_type=='full_mug' && $is_managed=='yes')?'selected="selected"':''; ?> >Managed Account</option>
											</select>
										</div>										
										<div class="clear"></div>
									</div>
			  ...
			  <div class="control_group">
									...
									<div class="control-group">
										<?php //print_r($bar_category); ?>
															<label class="control-label">Bar Category</label>
															<div class="controls">
																<select id="bar_category" name="bar_category[]" class="m_wrap wid360 span12 select2" multiple>
