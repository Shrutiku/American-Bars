...
class Bar extends SPACULLUS_Controller {
	...
	public function lists($limit='10',$options= '',$bar_title_new='',$bar_title_j='1V1',$address_j='1V1',$days='1V1',$offset=0,$msg='') {
		...
		if($_POST)
		{
		    ...
		    $bar_title = trim($this->input->post("bar_title"));
			$bar_title_j = trim($this->input->post("bar_title_j"));
			$address_j = trim($this->input->post("address_j"));
			$days = $this->input->post("days"); 	
				$bar_title_new = trim($this->input->post("bar_title_new")); 	
		...
		$config['base_url'] = base_url().'bar/lists/'.$limit."/".$options."/".base64_encode($bar_title_new).'/'.$bar_title_j.'/'.$address_j.'/'.$days.'/';
		//echo $state;
		//echo $bar_title;
		$config['total_rows'] = $this->bar_model->get_total_bar_count($bar_title,$state,$city,$zipcode,$bar_title_new,$bar_title_j,$address_j,$days);
		...
		$data['result'] = $this->bar_model->get_bar_result($offset,$limit,$sort_by,$sort_type,$bar_title,$state,$city,$zipcode,$bar_title_new,$bar_title_j,$address_j,$days);
		$data['msg'] = $msg;
 	...
 	function details($bar_slug = 0, $msg = '',$limit=4,$offset=0)
   {
   	    ...
   	    if($bar_slug=="" || $bar_slug=="0")
		{
         ...
         $this->session->set_userdata('detail',1);
...
function getallliquorbybar_new()
	...
	function suggest_bar($msg='')
	{
		...
		$this->form_validation->set_rules('bar_name', 'Bar Name', 'required|callback_bartitle_check');
		$this->form_validation->set_rules('address', 'Address', 'required');
		$this->form_validation->set_rules('state', 'State', 'required');
		$this->form_validation->set_rules('city', 'City', 'required');
