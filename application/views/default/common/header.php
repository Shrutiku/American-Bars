      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="b-menu-1">
		  ...
		  if(check_user_authentication ()!= ''){ ?>
			...
			<li ><a href="https://play.google.com/store/apps/details?id=com.spaculus.americanbars&hl=en" class="padding-top-bpttom"><img src="<?php echo $theme_url; ?>/images/Android-app-store_button.png" /></a></li>
