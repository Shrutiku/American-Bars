  		...
  		<div class="container">
     		<div class="bg_brown">
     			...
     			<div class="dashboard_detail">
     				<div class="result_search event"><div class="result_search_text"><i class="strip bar"></i> Favorite Bars</div></div>
		     		<div class="dashboard_subblock">
		     			<div>
		     				<div class="dash-btngroup">
	     						<div id="hd_del">
	     							<a class="btn btn-lg btn-primary marr_10" href="javascript:void(0)" onclick="searchmodal();">Add Favorite Bars</a>
				     				...
				     				<form class="form-horizontal" role="form">
					                   <div class="form-group">
					                       <div class="col-sm-8 input_box pull-left" style="padding: 0 5px 0 0;">
					                           <input type="text" name="event_keyword" id="event_keyword" class="form-control form-pad"  placeholder="Search My Favorite Bar" onkeydown="if (event.keyCode == 13) { get_search_event(); return false; }" />
					                       </div>
					                       <div class="col-sm-2 input_box pull-left" style="margin-right: 0;">
				                       	   ...
				                       	   <div class="col-sm-2 input_box pull-left" style="margin-right: 0;">
				                        		<a href="<?php echo site_url('user/favoritebar')?>" class="btn btn-lg btn-primary search" type="submit"><i class="strip refresh"></i>
				                       	   </a></div>
					...
					<input type="hidden" name="action" id="action" />
	     				...
	     				<?php echo $page_link;?>
							...
							<table class="table">
								...
								<?php $i++; } } else { ?>
									<tr>
										<td colspan="5">You have no favorite bars.</td>
									</tr>	
...
function deletefavbar(id)
 {
 	 
			alertify.confirm("Are you sure you want to delete this favorite bar?", function (e) {
				if (e) {
					 var res = $.ajax(
	        {						
			   type: 'POST',
			   url: '<?php echo site_url('bar/deletefavbar/')?>',
			   dataType: 'post', 
			   data : {id:id},
			   cache: false,
			   async: false,
			   beforeSend : function(){
				...
				complete: function(){
				     ...
				     $.growlUI('Your favorite bar deleted successfully .');
				    }
				}).responseText;
				bindJquery();
			}
...
function setupLabel() {
 ...
 function get_search_event()
 {
 	  ...
 	  var res = $.ajax(
	        {						
			   type: 'POST',
			   url: '<?php echo site_url('user/favoritebar/')?>',
			   dataType: 'post', 
