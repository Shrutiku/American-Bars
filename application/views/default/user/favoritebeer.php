  		...
  		<div class="container">
     		<div class="bg_brown">
     			...
     			<div class="dashboard_detail">
     				<div class="result_search event"><div class="result_search_text"><i class="strip beers"></i> Favorite Beer</div></div>
		     		<div class="dashboard_subblock">
		     			<div>
		     				<div class="dash-btngroup">
	     						<div id="hd_del">
	     							<a class="btn btn-lg btn-primary marr_10" href="javascript:void(0)" onclick="searchboxbeer();">Add Favorite Beers</a>
		                       		<a class="btn btn-lg btn-primary marr_10" href="javascript:void(0)" onclick="setaction('chk[]','delete',   'actionevent');">Delete</a>
	     						</div>
							</div>
				     				...
				     				<form class="form-horizontal" role="form">
					                   <div class="form-group">
					                       <div class="col-sm-8 input_box pull-left" style="padding: 0 5px 0 0;">
					                           <input type="text" name="event_keyword" id="event_keyword" class="form-control form-pad"  placeholder="Search My Favorite Beer" onkeydown="if (event.keyCode == 13) { get_search_event(); return false; }" />
					                       </div>
					                       <div class="col-sm-2 input_box pull-left" style="margin-right: 0;">
				                       	   ...
				                       	   <div class="col-sm-2 input_box pull-left" style="margin-right: 0;">
				                        		<a href="<?php echo site_url('user/favoritebeer')?>" class="btn btn-lg btn-primary search" type="submit"><i class="strip refresh"></i>
				                       	   </a></div>
					...
					<input type="hidden" name="action" id="action" />
	     				...
	     				<?php echo $page_link;?>
							...
							<table class="table">
								...
								<?php $i++; } } else { ?>
									<tr>
										<td colspan="6">You have no favorite beers.</td>
									</tr>	
...
<script>
function deletefavbeer(id)
 {
 	 
			alertify.confirm("Are you sure you want to delete this favorite beer?", function (e) {
				if (e) {
					 var res = $.ajax(
	        {						
			   type: 'POST',
			   url: '<?php echo site_url('beer/deletefavbeer/')?>',
			   dataType: 'post', 
			   data : {id:id},
			   cache: false,
			   async: false,
			   beforeSend : function(){
				...
				complete: function(){
				     ...
				     $.growlUI('Your favorite beer deleted successfully .');
				    }
				}).responseText;
				bindJquery();
			}
...
function setupLabel() {
 ...
 function get_search_event()
 {
 	  ...
 	  var res = $.ajax(
	        {						
			   type: 'POST',
			   url: '<?php echo site_url('user/favoritebeer/')?>',
			   dataType: 'post', 
...
<div class="modal fade login_pop2" id="searchboxbeer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	  <?php echo $this->load->view(getThemeName().'/home/searchboxbeer');?>	
</div>