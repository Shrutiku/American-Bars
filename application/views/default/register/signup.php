     		...
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow">
     				...
     				<h1 class="yellow_title padb10 br_bott_gray text-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h1>
	     				<form id="frm_signup" class="form-horizontal" role="form" action="<?php echo site_url("register/add_registration"); ?>" method="post">
	                       	<div class="padtb">
	        				 	<div class="col-sm-3">
	                     	...
	                     	<div class="padtb">
	                       	...
	                       	<div class="padtb8">
	                       		...
	                       		<div class="col-sm-7 mart10">
									...
									<input type="button" class="btn btn-lg btn-primary" value="Cancel">
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
