	     		...
	     		<div>
     				...
     				<div class="pad_t15b20 pad_lr10 br-bott-gray">
     					<div class="product-img position-relative">
     						<div class="position-relative new-product-img">
     							<?php $getimage = getsingleimage($product['store_id']);?>
     						<?php 
									if($getimage!="" && is_file(base_path().'upload/product_thumb/'.$getimage)){ ?>
								
										<img class="img-responsive" src="<?php echo base_url().'upload/product_thumb/'.$getimage; ?>"  />
									<?php
									}
									else{?>
     						  ...
     						  <?php $img123= "0"; if($product['product_name']=='Tshirt'){?>
					...
					{?>
		            	...
		            	<?php }  } ?>	
	     					...
	     					<?php if($product['product_name']=='Trucker Hat'){?>
					...
					{?>
		            	...
		            	<?php }  }  ?>	
     					...
     					<div class="product-detail">
     						<h1 class="productdetail-title"><?php echo $product['product_name'];?></h1>
     						<div class="mart10">
			    		 	...
			    		 	if($this->cart->contents())
			    		 	{
			    		 		foreach($this->cart->contents() as $crt)
								{
     							...
     							<a <?php echo $c; ?> id="disable_btn"  onclick="addToCart('<?php echo $product['store_id']; ?>','<?php echo $bar_id;?>');" class="btn btn-lg btn-primary">Add To Cart</a>
     						</div>
     					</div>
     					<div class="clearfix"></div>
     				</div>
     					...
     					<div class="related-product">
							...
							<?php } ?>
     							...
     							<div class="productlist-detail">
     								<h1 class="prduct-title"><a href="<?php echo site_url('shopping/details/'.$rs->product_slug); ?>"> <?php  echo strlen($rs->product_name)>40? substr($rs->product_name, 0,40).'...':$rs->product_name ;?> </a></h1>
     								<div class="mart10">
