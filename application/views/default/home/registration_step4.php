     		...
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow" style="width:870px">
					...
					<?php $attributes = array('id'=>'frm_login','name'=>'frm_login','class'=>'form-horizontal','rolde'=>'form');
							echo form_open('home/registration_step4',$attributes); ?>	
	                       ...
	                       <div class="padtb">
	        				...
	        				<div class="padtb">
	                       	...
	                       	<input type="hidden" name="type_bar" id="type_bar" value="<?php echo base64_decode($type); ?>" />
	                       	<div class="padtb8">
	                       		<div class="col-sm-12 mart10">
                                	<a class="btn btn-lg btn-primary btn-next pull-left" href="<?php echo site_url('home/registration_step3/'.base64_encode($bar_id).'/'.$type)?>"><i class="previous-arrow-icon"></i> Back</a>
