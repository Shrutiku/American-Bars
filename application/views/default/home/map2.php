<?php 
		...
		if($bar_detail_map)
		{
			...
			{
				$contentstring = '<html><body><div><p><b>Bar Name :</b>'.$r->bar_title.'</p><p><b>Bar Address :</b> '.$r->address.", ".$r->state.",".$r->zipcode.'</p></div></body></html>'	;
		...
		$var = "[".$var."]";
		 ...
		 $var1 = '['.$bar_detail['lat'].','.$bar_detail['lang'].',"'.$bar_detail['bar_title'].'"]';  
?>
<style>
	.pac-container
	{
