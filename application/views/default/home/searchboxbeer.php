     		...
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow">
     				<div class="result_search">
	     				...
	     				<h1 class="result_search_text box_title" id="login-block">Find Beers</h1>
	     				
     				</div><br>
                    
     				<div class="pad20">
     				
     				<form method="post" action="<?php echo site_url('beer/lists/');?>" role="form" id="bar_form_v113" class="form-horizontal mart10">
                   <div class="form-group">
                       <label class="col-sm-3 control-label" for="inputEmail3">Search  :</label>
                       <div class="col-sm-8 input_box">
                           <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input type="text" placeholder="Beer search by Name, Type and Brewed by" class="form-control form-pad" id="keyword" name="keyword" autocomplete="off">
                   ...
                   <div class="form-group">
                   		<div class="center">
	                   		...
	                   		<input type="hidden" value="10" id="limit" name="limit">
	                       		<a onclick="click1_beer()"  class="btn btn-lg btn-primary text-center  marr_10">Start Search</a>      
	                       		<div class="clearfix"></div>
	                       <!-- </div> -->
                       </div> 
