<style>
    ...
    background-color: rgba(5, 109, 0, 0.4) !important;
    cursor: pointer;
}							
</style>
     				...
     				<div class="">
	     					...
	     					<div class="padtb8">
	                       		<div class="col-sm-12 padding5 mart10">
	                       			<button type="submit" name="step2" id="step2" value="" class="btn btn-lg btn-primary btn-next next-right"/>Next <i class="next-arrow-icon"></i></button>
	                       			<a class="btn btn-lg btn-primary btn-next pull-left" href="<?php echo site_url('home/claim_bar_owner_register/'.base64_encode('1V1').'/1V1/'.$new_bar_id)?>"><i class="previous-arrow-icon"></i> Back</a>
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
	     					  <div class="col-md-12">
     					     ...
     					     <div class="col-md-4 col-md-12">
     					      <div class="register-newblock mar_top18 active_new  <?php if(isset($getbardatafeature['feature_id'])){ echo $getbardatafeature['feature_id'] ==1 ? 'active':'';}?>" id="full" onclick="changeblock('full');">
     					      	<i class="true-icon"></i>
		                ...
		                <div class="col-md-4 col-md-12">
     					      <div class="register-newblock mar_top18   <?php if(isset($getbardatafeature['feature_id'])){ echo $getbardatafeature['feature_id'] ==2 ? 'active':'';}?>" id="manage" onclick="changeblock('manage');">
     					      	<i class="true-icon"></i>
		        				  <div>
	        				...
	        				<input type="hidden" name="new_bar_id" id="new_bar_id" value="<?php echo @$new_bar_id; ?>" />
	                       	...
	                       	<div class="padtb8">
	                       		...
	                       		<div class="col-sm-12 padding5 mart10">
	                       			<button type="submit" name="step2" id="step2" value="" class="btn btn-lg btn-primary btn-next pull-right margin-top-30"/>Next <i class="next-arrow-icon"></i></button>
	                       			<a class="btn btn-lg btn-primary btn-next pull-left margin-top-30" href="<?php echo site_url('home/claim_bar_owner_register/'.base64_encode('1V1').'/1V1/'.$new_bar_id)?>"><i class="previous-arrow-icon"></i> Back</a>
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
	        			</form>
