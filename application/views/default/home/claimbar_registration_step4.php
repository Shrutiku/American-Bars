     	...
     	<div class="container">
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow">
     				...
     				<div>
     					<div>
     				<h1 class="yellow_title padb10 br_bott_gray text-center">Bar Owner Registration Step4 - Payment </h1>
     				<div>
     					<ul class="registration_steplist">
     						...
     						<li class="active last" href="<?php echo site_url('home/registration_step4')?>"><a >Step 4</a></li> -->
					...
					<?php $attributes = array('id'=>'frm_login','name'=>'frm_login','class'=>'form-horizontal','rolde'=>'form');
							echo form_open('home/claimbar_registration_step4/'.$new_bar_id,$attributes); ?>	
	        				...
	        				<div class="padtb">
	                       	...
	                       	<div class="padtb8">
	                       		<div class="col-sm-12 mart10">
	                       			<a class="btn btn-lg btn-primary btn-next pull-left" href="<?php echo site_url('home/claimbar_registration_step3/'.$new_bar_id)?>"><i class="previous-arrow-icon"></i> Back</a>
