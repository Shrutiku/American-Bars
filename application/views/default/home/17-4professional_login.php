    ...
    <div class="container">
  		<div class="jumbotron">
  			<?php $attributes = array('id'=>'frm_login','name'=>'frm_login','class'=>'form_horizontal');
									echo form_open('home/professional_login',$attributes); ?>
        	<section class="login-block">
                 ...
                 <div class="login-form">
                     ...
                     <?php if($msg!=""){
                        ...
                        {
                              echo "<div class='error text-center'>".INACTIVE_ACCOUNT."</div>";
                        }
                    ...
                    ?>
                      ...
                      <div class="col-lg-12 text-center">
                          <div class="radio-inline">
                              <label>
                                <input type="radio" name="login_radio" value="1" onclick="call_login();" />
                                Connectez-vous en tant que patient
                              </label>
                            </div>
                             <div class="radio-inline">
                              <label>
                                <input type="radio" name="login_radio" value="2" checked="checked" />
                 	...
                 	<div class="col-lg-12 margin-top-15">
                    	<div class="row">
                        	...
                        	<div class="col-lg-6">
                        	<input type="text" name="username" id="username" class="form-control" placeholder="Adresse email"> 
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        	 ...
                        	 <div class="checkbox col-lg-6">
                                 <label>
                                  <input type="checkbox" name="professional_remember_me" value="1" id="professional_remember_me" <?php if($professional_remember_me==1){?> checked="checked" <?php }?>>Rester connecté
                                </label>
                             </div>
							<div class="row">                           
                             <div class=" col-lg-6 text-right mmtop">
                               <a href="<?php echo site_url("forget_password/".base64_encode("doctor")) ?>" class="link underline"> Mot de passe oublié ?</a>
                             </div>
                           </div>  
