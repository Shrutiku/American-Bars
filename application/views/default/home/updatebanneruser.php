...
<?php
				...
				echo form_open_multipart('home/updatebannernew_user/',$attributes);
			  ?>	
			  <input type="hidden" name="prev_bar_banner" id="prev_bar_banner" value="<?php echo $bar_detail->user_banner; ?>" />
		     			...
		     			<div class="text-center pad_t15b20">
	                       	<div class="padtb">
	        				 	<div class="col-sm-3 text-right">
	                       		...
	                       		<?php
		          		if($bar_detail->user_banner!="" && file_exists(base_path().'upload/banner_drag_thumb/'.@$bar_detail->user_banner))
					{?>
		            	<img  src="<?php echo base_url()?>/upload/banner_drag_thumb/<?php echo $bar_detail->user_banner; ?>" alt="American Dive Bars"/>
		            	
		            	<div class="mar_top15"><a href="#modalimage" id="tt" data-toggle='modal' class="btn btn-lg btn-primary">Preview and Reposition</a></div>
		            	<?php }  else if($bar_detail->user_banner!="" && file_exists(base_path().'upload/banner_drag_without/'.@$bar_detail->user_banner))
					{?>
						<img src="<?php echo base_url()?>/upload/banner_without_drag/<?php echo $bar_detail->user_banner; ?>" alt="American Dive Bars"/>
     				...
     				<div class="result_search">
	        			...
	        			<input class="cover-position" name="pos" value="0" type="hidden">
	     						<div class="timeline-header-wrapper">	
	        						<div class=" cover-resize-wrapper"  id="preview" <?php	if($bar_detail->user_banner!=""){ ?>  style="display: block"; <?php }?>>
	        							
	        							
	        							<?php
		          		if($bar_detail->user_banner!="" && file_exists(base_path().'upload/barlogo_orig/'.@$bar_detail->user_banner))
					{  ?>
	     							<img id="previewimg" src="<?php echo base_url()?>upload/barlogo_orig/<?php echo $bar_detail->user_banner; ?>" />
	     							<?php } else {?>
	     					...
	     					<div class="padtb10 marl_10 text-center">	
	     						 ...
	     						 <input type="submit" name="submit" id="submit"  class="btn btn-lg btn-primary" value="Submit"  />
	     					</div>
