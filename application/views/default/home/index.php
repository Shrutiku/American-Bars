...
<img src="<?php echo $theme_url;?>/images/mainpageimg-restaurant-690569.jpg" style="width: 100%;">
            <div class="preloader">
                <p id="intro-scroll-button"  data-toggle="collapse" data-target="#myDiv">
                    <a class="scroll-down" >
           	        <h1 class="sony"></h1>
                    <span id="scrollbtn" class="scroll-message"  data-toggle="collapse" data-target="#myDiv" style="font-weight:bold; font-size:20px; color: #FFFFFF;">CLICK HERE TO EXPLORE </span>
