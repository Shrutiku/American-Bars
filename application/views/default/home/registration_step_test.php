     	...
     	<div class="container">
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow" style="width:870px">
     				...
     				<div>
     					<div>
     				<h1 class="yellow_title padb10 br_bott_gray text-center">Check How Your Business Appears Online:</h1>
     				<div>
     					<ul class="registration_steplist">
     						<li><a >Step 1</a></li>
     						<li ><a>Step 2</a></li>
     						<li><a class=active>Step Test</a></li>
     						<li><a>Step 3</a></li>
					...
					<?php $attributes = array('id'=>'frm_login','name'=>'frm_login','class'=>'form-horizontal','rolde'=>'form');
							echo form_open('home/registration_step_test/'.base64_encode($bar_id).'/'.$type,$attributes); ?>	
