	        				 ...
	        				 <div class="padtb mar_top20">
	        				 	<div class="col-sm-3">
	                       		...
	                       		<div class="input_box col-sm-7">
	                           		<input type="text" name="bar_title" maxlength="40" readonly="readonly" class="tags form-control form-pad" id="bar_title" placeholder="Start Typing..." <?php if($this->session->userdata('viewid_orig')!='' && $this->session->userdata('viewid_orig')!=0){ ?> <?php }?> value="<?php echo @$bar_title; ?>">
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
