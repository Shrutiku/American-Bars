     		...
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow" style="width: 90%;">
     				<div class="result_search"><br/>
	     				<div class="result_search_text" style="text-align: center">Claim Your Bar in 3 Easy Steps</div>
                                                      				...
                                                      				<h1 class="yellow_title padb10 br_bott_gray" style="text-align: center;">Step 1: Search Your Bar Profile</h1>
                                                                                ...
                                                                                <br>
                                                                                <img src="<?php echo base_url() . getThemeName(); ?>/images/claimbar_search_result_ex.png" border="0" style="max-width:100%;max-height:20%;"><br/><br/>
                                                                                <h1 class="yellow_title padb10 br_bott_gray" style="text-align: center;">Step 3: Finish the Easy and Quick Claim Process</h1><br/>
					...
					<form class=""  role="form" action="<?php echo site_url("bar/lists") ?>" method="post">
                			<div class=""><input type="text" name="bar_title_new"  id="bar_title_new" class="form-control bar_title_new" placeholder="Search by Bar Name, City or Zip"></div>
