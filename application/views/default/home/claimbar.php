     		...
     		<div class="result_box clearfix mar_top30bot20">
				...
				<img src="<?php echo base_url() . getThemeName(); ?>/images/claimbar.jpg" border="0" style="max-width:100%;max-height:60%;">
                                                      				...
                                                      				<h1 class="yellow_title padb10 br_bott_gray" style="text-align: center;">Step 1:</h1>
                                                                                ...
                                                                                <img src="<?php echo base_url() . getThemeName(); ?>/images/claimbar_search_result_ex.jpg" border="0" style="max-width:100%;max-height:60%;">
					...
					<form class=""  role="form" action="<?php echo site_url("bar/lists") ?>" method="post">
                			<div class="pull-left" style="text-align: center;"><input type="text" name="bar_title_new" id="bar_title_new" class="form-control bar_title_new" placeholder="By Name, City Or Zip"></div>
                    			<div class="pull-left" style="text-align: center;"><button class="btn btn-lg btn-primary btn-block yellowlink   " type="submit">Claim Your Bar Now!</button></div>
              </form>
     			</div>
     		</div>
   		</div>
