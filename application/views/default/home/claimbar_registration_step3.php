     			...
     			<div class="login_block br_green_yellow">
     				...
     				<div>
     					<ul class="registration_steplist">
     						...
     						<li ><a href="<?php echo site_url('home/registration_step2')?>">Step 2</a></li>
     						<li class="active"><a href="<?php echo site_url('home/registration_step3')?>">Step 3</a></li>
					...
					<?php $attributes = array('id'=>'frm_login','name'=>'frm_login','class'=>'form-horizontal','rolde'=>'form');
							//echo form_open('home/claimbar_registration_step3/'.base64_encode($bar_id).'/'.$type,$attributes); 
							echo form_open('home/claimbar_registration_step3/'.$new_bar_id."/".base64_encode($bar_id),$attributes); ?>	
	                       	...
	                       	<div class="padtb">
	                       		...
	                       		//echo $count;
	                       		 if($count==1){ echo "Full Mug"; } else if($count==2){ echo "Managed Account"; } else { echo "Half Mug"; }?> </b></p>
	        				 	...
	        				 	<?php if($count>0){ ?>
	        				 	<h1 class="step_title mar_top20">Total Payment : $ <?php $site_seting = site_setting(); if($count==1){ echo $site_setting->amount; } else if($count==2){ echo $site_setting->managed_account_amount; } else { echo "Free"; } ?></h1>
	        				 	<?php } ?>
	                       	</div>
	                       	...
	                       	<div class="padtb8">
	                       		...
	                       		<a class="btn btn-lg btn-primary btn-next pull-left" href="<?php echo site_url('home/claimbar_registration_step2/'.$new_bar_id."/".base64_encode($bar_id))?>"><i class="previous-arrow-icon"></i> Back</a>
	                       			...
	                       			<!-- <a class="btn btn-lg btn-primary" href="<?php echo site_url('home/registration_step2/'.$type.'/'.base64_encode($bar_id))?>">Back</a> -->
