	                     	...
	                     	<div class="padtb mar_top20">
	                       	...
	                       	<div class="padtb">
	        				 	<div class="col-sm-3 text-right">
	                       		...
	                       		<div class="input_box col-sm-7">
                                            <textarea rows="1" placeholder="Address" name="address" id="address" class="form-control form-pad" ><?php echo @$getalldata->address; ?></textarea>
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
...
<!--	                       	<div class="padtb">
                        ...
                        <?php } else { ?>
                                                <a class="btn btn-lg btn-primary pull-right marr_10" href="<?php echo site_url('/home/updatebanner');?>">Update Banner</a><div class="clear"></div>
