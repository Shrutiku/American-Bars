...
<div>
	<div class="wrapper row5 beer-list" style="border:<?php echo $v==0 ? 'none':'';?>">
			...
			<form class="form-horizontal" id="cocktail-search-frm" method="post" role="form" action="<?php echo base_url("cocktail/lists"); ?>">
						    ...
						    <div class="form-group  pull-right">	
								...
								<label for="inputEmail3" class="control-label">Sort By :</label>
								 <select class="select_box" name="order_by" id="order_by" onchange="set_orderby('<?php echo $limit;?>','<?php echo $alpha;?>','<?php echo $options;?>','<?php echo $keyword;?>','<?php echo $offset; ?>')">
									...
									<option value="cocktail_name#ASC" <?php if($order_by == "cocktail_name#ASC"){ ?> selected="selected" <?php } ?>>Name A-Z</option>
									<option value="cocktail_name#DESC"<?php if($order_by == "cocktail_name#DESC"){ ?> selected="selected" <?php } ?>>Name Z-A</option>									
								 </select>
						   </div>
						   <div class="clearfix"></div>
					  </div>
				...
				<div class="pull-right" style="width: 27%;">
					<a href="#suggestmodal" onclick="blank()"  data-toggle="modal" class="btn btn-lg btn-primary extra_cls">Suggest New Cocktail</a>
			  ...
			  <div class="left_block<?php echo $classnew;?>">
				...
				<div class="alphabate_block">
					<ul class="alphabate_list <?php echo $w==0 ? 'wid-72':'';?>">
						...
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("a")); ?>" <?php if($alpha == "a"){ ?> class="active" <?php }?>>a</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("b")); ?>" <?php if($alpha == "b"){ ?> class="active" <?php }?>>b</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("c")); ?>" <?php if($alpha == "c"){ ?> class="active" <?php }?>>c</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("d")); ?>" <?php if($alpha == "d"){ ?> class="active" <?php }?>>d</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("e")); ?>" <?php if($alpha == "e"){ ?> class="active" <?php }?>>e</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("f")); ?>" <?php if($alpha == "f"){ ?> class="active" <?php }?>>f</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("g")); ?>" <?php if($alpha == "g"){ ?> class="active" <?php }?>>g</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("h")); ?>" <?php if($alpha == "h"){ ?> class="active" <?php }?>>h</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("i")); ?>" <?php if($alpha == "i"){ ?> class="active" <?php }?>>i</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("j")); ?>" <?php if($alpha == "j"){ ?> class="active" <?php }?>>j</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("k")); ?>" <?php if($alpha == "k"){ ?> class="active" <?php }?>>k</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("l")); ?>" <?php if($alpha == "l"){ ?> class="active" <?php }?>>l</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("m")); ?>" <?php if($alpha == "m"){ ?> class="active" <?php }?>>m</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("n")); ?>" <?php if($alpha == "n"){ ?> class="active" <?php }?>>n</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("o")); ?>" <?php if($alpha == "o"){ ?> class="active" <?php }?>>o</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("p")); ?>" <?php if($alpha == "p"){ ?> class="active" <?php }?>>p</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("q")); ?>" <?php if($alpha == "q"){ ?> class="active" <?php }?>>q</a></li>
						<li><a href="<?php echo site_url("beer/lists/".$limit."/".base64_encode("r")); ?>" <?php if($alpha == "r"){ ?> class="active" <?php }?>>r</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("s")); ?>" <?php if($alpha == "s"){ ?> class="active" <?php }?>>s</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("t")); ?>" <?php if($alpha == "t"){ ?> class="active" <?php }?>>t</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("u")); ?>" <?php if($alpha == "u"){ ?> class="active" <?php }?>>u</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("v")); ?>" <?php if($alpha == "v"){ ?> class="active" <?php }?>>v</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("w")); ?>" <?php if($alpha == "w"){ ?> class="active" <?php }?>>w</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("x")); ?>" <?php if($alpha == "x"){ ?> class="active" <?php }?>>x</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("y")); ?>" <?php if($alpha == "y"){ ?> class="active" <?php }?>>y</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("z")); ?>" <?php if($alpha == "z"){ ?> class="active" <?php }?>>z</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("'-#")); ?>" <?php if($alpha == "'-#"){ ?> class="active" <?php }?>>['-#]</a></li>
						<li><a href="<?php echo site_url("cocktail/lists/".$limit."/".base64_encode("0-9")); ?>" <?php if($alpha == "0-9"){ ?> class="active" <?php }?>>[0-9]</a></li>
						<div class="clearfix"></div>
					</ul>
				...
				<div>
					<div class="advance-block padt10">
						   <div class="form-group">
							   <div class="col-sm-4 padding-right-0 input_box pull-left" style="padding-left: 0px;">
								   <input type="text" class="form-control form-pad  " id="keyword" name="keyword" placeholder="Search by Cocktail" value="<?php echo htmlentities($keyword); ?>">
							   ...
							   <div class="col-sm-4 padding-right-0 input_box pull-left" style="padding-left: 0px;">
								   <input type="text" class="form-control form-pad  " id="keyword1" name="keyword1" placeholder="Search by Base Spirit" value="<?php echo htmlentities($keyword1); ?>">
							   </div>
							   <div class="col-sm-2 input_box pull-left">
									<button onclick="gosearch('<?php echo $limit;?>','<?php echo $alpha;?>','<?php echo $options;?>','<?php echo $keyword;?>','<?php echo $offset; ?>');" class="btn  btn-lg btn-primary small-search"><i class="strip search"></i></button>
							   </div>
				...
				<div class="result_box liquor-box clearfix">
					...
					<?php if($result){
						...
						<li class="active">
							<div class="media">
								<a class="pull-left widheig120" href="<?php echo site_url("cocktail/detail/".$rs->cocktail_slug);?>">
								<?php 
									if($rs->cocktail_image!="" && is_file(base_path().'upload/cocktail_list/'.$rs->cocktail_image)){ ?>
										<img src="<?php echo base_url().'upload/cocktail_list/'.$rs->cocktail_image; ?>"  height="119px" width="120px" />
									<?php
									}
									else{?>
									<img height="119" width="120" src="<?php echo base_url().'upload/cocktail_thumb/no_image.png'; ?>" />
							<?php } ?>
							</a>
                            <div class="pull-left btn btn-lg btn-primary text-center full-detail-btn"><a href="<?php echo site_url("cocktail/detail/".$rs->cocktail_slug);?>">Full Details</a></div>
								<div class="media-body">
								   <div class="reult_sub_title"><h4 class="media-heading"><a class="pull-left listing-title" href="<?php echo site_url("cocktail/detail/".$rs->cocktail_slug);?>"><?php echo $rs->cocktail_name; ?></a></h4></div>
