...
<<<<<<< HEAD
	 <li><h3><?php echo "<span class='yellow_text'></span>" . $row1->day_from . " - " . $row1->day_to; ?> <span class='yellow_text'>From </span> : <?php echo $row1->hour_from ." To ". $row1->hour_to; ?></h3><br> 	
=======
...
>>>>>>> aebac673681b6f12f95c4f7fdc2d85a7fd2ad849
