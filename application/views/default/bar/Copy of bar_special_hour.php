	                     ...
	                     <div id="hide_edit">
	                       ...
	                       <div id="innerbeer" >	
	                       	...
	                       	<div class="padtb8">
                                ...
                                <input type="hidden" name="bid" id="bid_0" value="" />
	                       ...
	                       <div id="innerother" >	
	                       	...
	                       	<div class="padtb8">
	                       		...
	                       		<div class="col-sm-3" style="padding-left: 15px;">	
	                       			<input type="text" class="form-control tagsother form-pad" id="otherid_0"  name="otherid[]" value="">
	                       		</div>	
	                       		<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px;; padding-left: 5px; padding-right: 5px;">
	        				 		<label class="control-label" style="font-size: 16px;">Price : $ </label>
	        				 	</div>
...
$('#add_row').click(function(){
	    ...
	    html += '<div class="padtb8"><div class="col-sm-3 text-right"><label class="control-label">Beers : </label></div>';
	    html += '<input type="hidden" name="bid" id="bid_'+cnt+'" value="" />'
	    html += '<div class="col-sm-3" style="padding-left: 15px;">';	
	    html += '<input type="text" class="form-control tagsbeer form-pad" id="beerid_'+cnt+'"  name="beerid[]" value=""></div>';	
	    ...
	    html += '</div><a href="javascript://;" id="add_rowbeer" name="add_rowbeer" class="add_rowbeer btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a>';
	    html += '<div class="clearfix"></div></div>';
	    
	    
	    html += '<div class="padtb8"><div class="col-sm-3 text-right"><label class="control-label">Cocktails : </label></div>';
	    html += '<input type="hidden" name="cid" id="cid_'+cnt+'" value="" />'
	    html += '<div class="col-sm-3" style="padding-left: 15px;">';	
	    html += '<input type="text" class="form-control tagscocktail form-pad" id="cocktailid_'+cnt+'"  name="cocktailid[]" value=""></div>';	
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px;; padding-left: 5px; padding-right: 5px;">';
	    html += '<label class="control-label" style="font-size: 16px;">Price : $ </label></div>';
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right: 24px;">';	
	    html += '<input type="text" class="form-control form-pad" id="cocktailprice'+cnt+'" name="cocktailprice[]" value="">';
	    html += '</div><a href="javascript://;" id="add_rowcocktail" name="add_rowcocktail" class="add_rowcocktail btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a>';
	    html += '<div class="clearfix"></div></div>';
	    
	     html += '<div class="padtb8"><div class="col-sm-3 text-right"><label class="control-label">Liquors : </label></div>';
	    html += '<input type="hidden" name="lid" id="lid_'+cnt+'" value="" />'
	    html += '<div class="col-sm-3" style="padding-left: 15px;">';	
	    html += '<input type="text" class="form-control tagsliquor form-pad" id="liquorid_'+cnt+'"  name="liquorid[]" value=""></div>';	
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px;; padding-left: 5px; padding-right: 5px;">';
	    html += '<label class="control-label" style="font-size: 16px;">Price : $ </label></div>';
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right: 24px;">';	
	    html += '<input type="text" class="form-control form-pad" id="liquorprice'+cnt+'" name="liquorprice[]" value="">';
	    html += '</div><a href="javascript://;" id="add_rowliquor" name="add_rowliquor" class="add_rowliquor btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a>';
	    html += '<div class="clearfix"></div></div>';
	      
	    html += '<div class="padtb8"><div class="col-sm-3 text-right"><label class="control-label">Foods  : </label></div>';
	    html += '<div class="col-sm-3" style="padding-left: 15px;">';	
	    html += '<input type="text" class="form-control form-pad" id="foodid_'+cnt+'"  name="foodid[]" value=""></div>';	
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px;; padding-left: 5px; padding-right: 5px;">';
	    html += '<label class="control-label" style="font-size: 16px;">Price : $ </label></div>';
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right: 24px;">';	
	    html += '<input type="text" class="form-control form-pad" id="foodprice'+cnt+'" name="foodprice[]" value="">';
	    html += '</div><a href="javascript://;" id="add_rowfood" name="add_rowfood" class="add_rowfood btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a>';
	    html += '<div class="clearfix"></div></div>';
	    
	    html += '<div class="padtb8"><div class="col-sm-3 text-right"><label class="control-label">Others  : </label></div>';
	    html += '<div class="col-sm-3" style="padding-left: 15px;">';	
	    html += '<input type="text" class="form-control form-pad" id="otherid_'+cnt+'"  name="otherid[]" value=""></div>';	
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px;; padding-left: 5px; padding-right: 5px;">';
	    html += '<label class="control-label" style="font-size: 16px;">Price : $ </label></div>';
	    html += '<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right: 24px;">';	
	    html += '<input type="text" class="form-control form-pad" id="otherprice'+cnt+'" name="otherprice[]" value="">';
	    html += '</div><a href="javascript://;" id="add_rowother" name="add_rowother" class="add_rowother btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a>';
	    html += '<div class="clearfix"></div></div>';
		...
		var html = '';
		html += '<div class="padtb" id="imgfood_'+cnt+'" style="display:none;"><div class="padtb8">';
	    html +=  '<div class="col-sm-3 text-right">';
	    html +=  '<label class="control-label"></label>';
	    html +=   '</div>';
	     html +=         		'<div class="col-sm-3" style="padding-left: 15px;">';
	   html +=                   			'<input type="text" class="form-control form-pad" id="foodid_'+cnt+'"  name="foodid[]" value="">';
	   html +=                   		'</div>';
	   ...
	   html +=    				 	'</div>';
	   html +=                   		'<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right:24px; ">';	
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="foodprice_'+cnt+'" name="foodprice[]" value="">';
	   html +=                   		'</div>'	;
		...
		var html = '';
		html += '<div class="padtb" id="imgother_'+cnt+'" style="display:none;"><div class="padtb8">';
	    html +=  '<div class="col-sm-3 text-right">';
	    html +=  '<label class="control-label"></label>';
	    html +=   '</div>';
	     html +=         		'<div class="col-sm-3" style="padding-left: 15px;">';
	   html +=                   			'<input type="text" class="form-control form-pad" id="otherid_'+cnt+'"  name="otherid[]" value="">';
	   html +=                   		'</div>';
        html +=                       '<div class="col-sm-3" style="width: 10%; padding-left: 5px; padding-right: 5px;">';
	   html +=    				 		'<label class="control-label " style="font-size: 16px;">Price : $</label>';
	   html +=    				 	'</div>';
	   html +=                   		'<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right:24px; ">';	
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="otherprice_'+cnt+'" name="otherprice[]" value="">';
	   html +=                   		'</div>'	;
	    ...
	    html +=  ' <input type="hidden" name="bid" id="bid_'+cnt+'" value="" /><div class="col-sm-3 text-right">';
	    html +=  '<label class="control-label"></label>';
	    html +=   '</div>';
	     html +=         		'<div class="col-sm-3" style="padding-left: 15px;">';
	  ...
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="beerprice_'+cnt+'" name="beerprice[]" value="">';
	   html +=                   		'</div>'	;
		...
		var html = '';
		html += '<div class="padtb" id="imgcocktail_'+cnt+'" style="display:none;"><div class="padtb8">';
	   ...
	   html +=    				 	'</div>';
	   html +=                   		'<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right:24px; ">';	
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="cocktailprice_'+cnt+'" name="cocktailprice[]" value="">';
	   html +=                   		'</div>'	;
	  ...
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="cocktailprice_'+cnt+'" name="cocktailprice[]" value="">';
	   html +=                   		'</div>'	;
		...
		var html = '';
		html += '<div class="padtb" id="imgliquor_'+cnt+'" style="display:none;"><div class="padtb8">';
	   ...
	   html +=    				 	'</div>';
	   html +=                   		'<div class="col-sm-2" style="width: 10%;  padding-left: 5px; padding-right: 5px; margin-right:24px; ">';	
	  html +=                    			'<input type="text" class="form-control form-pad timepicker-default" id="liquorprice_'+cnt+'" name="liquorprice[]" value="">';
	   html +=                   		'</div>'	;
