     	...
     	<div class="container">
     		<div class="margin-top-50 bg_brown">
     			...
     			<div class="dashboard_detail">
     				<div class="result_search event"><div class="result_search_text"><i class='glyphicon glyphicon-calendar' style="color:'#FFF'; display: block; font-size: 46px; vertical-align: middle; margin: auto;"></i> Events</div></div>
	                       ...
	                       <div id="inner1" >	
	                       	...
	                       	<div class="padtb">
	        				 	...
	        				 	<div class="col-sm-3 text-right">
	                       		...
	                       		<div class="input_box col-sm-7">
	                           		<input type="text" class="form-control form-pad" id="city1" name="city" value="">
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
	        				 	...
	        				 	<div class="col-sm-3 text-right">
	                       		...
	                       		<div class="input_box col-sm-7">
	                           		<input type="text" class="form-control form-pad" id="state1" name="state" value="">
	                       		</div>
	                       		<div class="clearfix"></div>
	                       	</div>
