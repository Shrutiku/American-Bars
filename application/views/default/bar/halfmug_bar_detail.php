      ...
      <div class="container">
      	<div class="full_mug">
     		<div class="result_search">
     			<div class="pull-left">
	     			<div class="result_search_text"><?php echo "Welcome to " .$bar_detail['bar_title'];?><b style="color:#3b5998;padding-left:3em"><?php echo "    ".($bar_detail['followers'] + count($bar_liker))." Followers";?></b></div>
	            </div>
