						    ...
						    <!-- <?php $cnt_like = like_checker_bar($bar_detail['bar_id'],$this->session->userdata('user_id')); 
								...
								<!-- <a id="total-fav" href="javascript:void(0);" name="2" class="btn btn-lg btn-primary full-btn mart10">Add To Favoritess</a> -->
									...
									<?php
                                                                ...
                                                                <p></p>
                                                                <div>
                                    <a href="<?php echo site_url('home/claim_bar_owner_register/'.base64_encode('1V1').'/1V1/'.base64_encode($bar_detail['bar_id']));?>" style="background-color: #4CAF50;" class="review text-center"><b>Claim Bar!</b></a>
						        	 	</div><?php }
                                                ...
                                                <div class="login_block br_green_yellow">
                                                        ...
                                                        <div class="pad20">
                                                            ...
                                                            <p>
                                                                ...
                                                                <img src="//maps.googleapis.com/maps/api/streetview?size=600x300&location=<?php echo $bar_detail['address'];?> <?php echo $bar_detail['city'];?>, <?php echo $bar_detail['state'];?> <?php echo $bar_detail['zip'];?>&pitch=0&key=AIzaSyA3USy3JEMB1_mCg_ud0UDKYrzEa8657Uo" border="1px">
                                                            </p>
