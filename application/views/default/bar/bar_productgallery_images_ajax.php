...
<?php 
												...
												<div class="padtb" id="pi_<?php echo $im->product_image_id ?>">
													<div class="col-sm-3 text-right">
	        				 		<label class="control-label">Product Image <?php echo $i+1;?></label>
	        				 	</div>
											<div class="input_box upload_btn" data-provides="fileupload">
														<input type="file" accept="image/*" class="form-control form-pad" value="<?php echo $im->product_image_name; ?>" id="photo_image" name="photo_image[]">
															</div>
												...
												<?php }else{ ?>
												<a href="javascript://"  class="btn btn-lg btn-primary search marr_10 pull-left" onclick="removeImageDiveAjax('<?php echo $im->product_image_id ?>')"><span class="glyphicon glyphicon-minus"></span></a>
												<?php } ?>
												<div class="input_box upload_user">
	                           								<img class="img-responsive" src="<?php echo base_url().'upload/product_thumb_80/'.$im->product_image_name ?>" />
	                       						</div>
