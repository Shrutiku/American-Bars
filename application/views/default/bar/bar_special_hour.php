                                                    ...
                                                    <div id="pi_<?php echo $im->bar_hour_id ?>">	
                                                        <input type="hidden" name="bar_hour_id[]" id="bar_hour_id" value="<?php echo $im->bar_hour_id; ?>" />
                                                            <div class="padtb8">
                                                                ...
                                                                <a href="javascript://;" id="" onclick="addnewrows('<?php echo $i; ?>')" name="add_rowbeer" class="add_rowbeer btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a> 
...
//                html += '</div>';
                ...
                html += '<a href="javascript://;" id="" onclick="addnewrows('<?php echo $i; ?>')" name="add_rowbeer" class="add_rowbeer btn btn-lg btn-primary search marr_10 pull-left"><span class="glyphicon glyphicon-plus "></span></a> ';
                html += '<div class="clearfix"></div>';
