                    ...
                    <div class="dashboard_subblock">
                        <div>
                            <div id="list_show">
                                ...
                                <form name="add_event" id="product_type" method="post" enctype="multipart/form-data" action="<?php echo site_url('bar/bar_happy_hour'); ?>" onsubmit="return validate()" autocomplete="off">
                                    <form name="add_event" id="product_type" method="post" enctype="multipart/form-data" action="<?php echo site_url('bar/bar_happy_hour'); ?>" >
