     		...
     		<div class="padtb10">
     			...
     			<div class="review_mainblock marr4">
     				<div class="products_block">
     					<h1 class="productbar_title"><div>Buy Our Bar Gear</div></h1>
	     		      <ul class="bxsliderp">
	     				<?php $getproducts = getallproductsByBarID($bar_detail['bar_id']);
	     			//echo $bar_detail['prtshirt'];
						//echo "<pre>";
						//print_r($getproducts);
						//die;
	     				if($getproducts){
	     			    $i=0; foreach($getproducts as $row){ 
	     			    	//echo $row->store_id;
	     			    	//echo $bar_detail['prtshirt'];
	     			    	
	     			    	//echo $i;
							 ?>
	     			    		<?php if($bar_detail['prtshirt']=='enable' || $bar_detail['prcap']=='enable' || $row->bar_id!=0 ){ 
	     			    			
	     			    			$i=1;?>	
	     				<li>
	     				<div class="products marr_10 mar_top20 position-relative">
						<?php $getimage = getsingleimage($row->store_id);?>
						<?php if($bar_detail['bar_id']==$row->bar_id){?>
     								<a target="_blank" href="<?php echo site_url('shopping/details/'.$row->product_slug); ?>">
     								<?php } else {?>
     									<a target="_blank" href="<?php echo site_url('shopping/productdetails/'.$row->product_slug.'/'.$bar_detail['bar_id']); ?>">
     								<?php } ?>		
     									<?php 
									if($getimage!="" && is_file(base_path().'upload/product_thumb_254/'.$getimage)){ ?>
										<img src="<?php echo base_url().'upload/product_thumb_254/'.$getimage; ?>"  />
									<?php
									}
									else{?>
	     						...
	     						<div class="prod">
	     							<div class="pull-left">
	     								<h1 class="prodct"><?php echo $row->product_name;?> <span class="marl_10"><?php echo $site_setting->currency_symbol." ".number_format($row->price,2);?> </span></h1>
	     								<!-- <p>$24.29</p> -->
	     							</div>
	     							<!-- <div class="pull-right">
	     								<a href="<?php echo site_url('shopping/productdetails/'.$row->product_slug.'/'.$bar_detail['bar_id']); ?>"><img src="<?php echo base_url().'default'?>/images/cart.png"/></a>
	     							</div> -->
	     							<div class="clearfix"></div>
	     						</div>
	     						</a> 
	     						<?php $img123= ""; if($row->product_name=='Tshirt'){?>
	     							
						<?php
		          		if($bar_detail['tshirt_logo']!="" && file_exists(base_path().'upload/product_logo_thumb/'.@$bar_detail['tshirt_logo']))
					{?>
		            	<?php $img123 =  base_url().'/upload/product_logo_thumb/'.$bar_detail['tshirt_logo']; ?>
		            	<?php }  } ?>	
		            		
	     					<?php if($row->product_name=='Trucker Hat'){?>
	     							
						<?php
		          		if($bar_detail['cap_logo']!="" && file_exists(base_path().'upload/product_logo_thumb/'.@$bar_detail['cap_logo']))
					{?>
		            	<?php $img123 =  base_url().'/upload/product_logo_thumb/'.$bar_detail['cap_logo']; ?>
		            	<?php }  } ?>	
		            		<?php if($bar_detail['bar_id']!=$row->bar_id && $img123!=''){?>
		            			
		            			<div class="logo-block">
	     							
	     							<img src="<?php echo $img123; ?>" alt="" class="img-responsive" />
	     						</div>
	     					<?php } ?>	
	     					</a>
	     				</div>
	     			...
	     			<?php  }  } } else { ?>
	     				...
	     				<?php // if($bar_detail['prcap']=='enable'){ ?>
