     		...
     		<div class="result_box clearfix mar_top30bot20">
     			<div class="login_block br_green_yellow">
	        			...
	        			<div id="signup-form" class="signup">
	     				...
	     				<i class="strip login_icon"></i><div class="result_search_text" >Report This Taxi Company</div>
     				</div> 
     				<div class="pad20">
					...
					<?php $attributes = array('id'=>'report_bars','name'=>'report_bars','class'=>'form-horizontal','rolde'=>'form');
							echo form_open_multipart('taxiowner/add_report_taxi',$attributes); ?>	
							<input type="hidden" name="taxi_id" id="taxi_id" value="<?php echo $taxi_detail['taxi_id'];?>" />
	     				<div class="error1 hide1 center" id="cm-err-main1_sug">&nbsp;</div>
	        				<div id="ajax_msg_error_reg1_sug"></div>
	        				<div class="radio_block text-left">
		        				<div class="padtb">
		        				 	<div>
		        				 		<h2 class="sign-title"><?php echo ucwords($taxi_detail['taxi_company']); ?> Taxi Company Is : </h2>
		        				 	</div>
	        				 	...
	        				 	<div class="pull-left">
		                       	...
		                       	<div class="padtb">
		        				 	<div>
		        				 		<div class="radio">
		        				 			<p><label><input checked="checked" type="radio" name="report_type" id="report_type1" value="No Longer in Business" onclick="hidetextbox()" />No Longer in Business</label></p>
		        				 			<p><label><input type="radio" name="report_type" id="report_type1" value="Contract Information Incorrect" onclick="hidetextbox()" />Contract Information Incorrect</label></p>
        ...
        success: function(json)          //on receive of reply
            {
			  ...
			  .removeAttr('checked')
			  .removeAttr('selected');
			  $.growlUI('<?php echo "Your taxi company report send successfully ."; ?>');
			  setTimeout(function() {
					      window.location.href = "<?php echo site_url('taxiowner/lists');?>";
						}, 1000);
