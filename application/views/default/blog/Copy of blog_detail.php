<?php
					...
					{?>
		            	<?php $img =  base_url().'/upload/blog_orig/'.$blog_detail['blog_image']; ?>
		            	<?php }  else { ?>
...
function fbShare(){
	window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('<?php echo site_url('article/detail/'.$blog_detail['slug']); ?>'),'facebook-share-dialog','width=626,height=436');
            return false;
}
		            	</script>	
<style>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6&appId=322878041237170";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>

<div class="fb-share-button" data-href="<?php echo site_url('article/detail/'.$blog_detail['slug']); ?>" data-layout="button_count" data-mobile-iframe="true"></div>