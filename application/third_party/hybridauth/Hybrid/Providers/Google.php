...
class Hybrid_Providers_Google extends Hybrid_Provider_Model_OAuth2 {
	...
	function initialize() {
		...
		$this->api->curl_header = array("Authorization: OAuth " . $this->api->access_token, "Content-Type: application/json");
	...
	function addUrlParam($url, array $params) {
        ...
        function setUserStatus($status) {
            ...
            $response = $this->api->post("https://www.googleapis.com/plusDomains/v1/people/$user_id/activities", json_encode($params));
